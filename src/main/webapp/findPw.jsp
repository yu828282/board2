	      ...
	      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
	        <div class="card card-signin my-5 shadow p-3 mb-5 bg-white rounded">
	          <div class="card-body py-5">
	            ...
	            <form class="form-signin" method="post" action="findPwAction.jsp">
	              ...
	              <div class="form-floating">
	                <input type="text" name="userEmail" class="form-control my-1" placeholder="" style="ime-mode:active" required>
	              	<label for="floatingInput">이메일<span style="color:red;"> * </span></label>
	              </div>
	              <hr>	
					<div class="d-grid gap-2 ">
					  <button class="btn btn-primary" type="submit">비밀번호 찾기</button>
					  <button class="btn btn-outline-secondary" onclick="location.href='findId.jsp'" type="button">아이디 찾기</button>
